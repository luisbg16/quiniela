 ...
 *
 * Nota: equipos "Por definir" serán confirmados tras repechajes de marzo 2026.
 */
...
const MATCHDAY_1 = [
  ...
  m(2,  "Grupo A", "Jun 11, 2026", "10:00 PM ET", "Corea del Sur", "🇰🇷",   "Por definir",   "🏳️",    "Estadio Akron, Zapopan"),

  // Jun 12
  m(3,  "Grupo B", "Jun 12, 2026", "3:00 PM ET",  "Canadá",        "🇨🇦",   "Por definir",   "🏳️",    "BMO Field, Toronto"),
  ...
  m(10, "Grupo D", "Jun 14, 2026", "9:00 PM ET",  "Australia",     "🇦🇺",   "Por definir",   "🏳️",    "Lincoln Financial Field, Filadelfia"),
  ...
  // Jun 16
  m(14, "Grupo F", "Jun 16, 2026", "12:00 PM ET", "Túnez",         "🇹🇳",   "Por definir",   "🏳️",    "Hard Rock Stadium, Miami"),
  ...
  m(19, "Grupo K", "Jun 17, 2026", "1:00 PM ET",  "Portugal",      "🇵🇹",   "Por definir",   "🏳️",    "NRG Stadium, Houston"),
  ...
  m(23, "Grupo I", "Jun 17, 2026", "9:00 PM ET",  "Noruega",       "🇳🇴",   "Por definir",   "🏳️",    "Gillette Stadium, Boston"),
...
const MATCHDAY_2 = [
  ...
  m(26, "Grupo B", "Jun 19, 2026", "6:00 PM ET",  "Suiza",         "🇨🇭",   "Por definir",   "🏳️",    "Hard Rock Stadium, Miami"),
  m(27, "Grupo C", "Jun 19, 2026", "9:00 PM ET",  "Brasil",        "🇧🇷",   "Haití",         "🇭🇹",   "Lincoln Financial Field, Filadelfia"),

  // Jun 20
  m(28, "Grupo D", "Jun 20, 2026", "3:00 PM ET",  "USA",           "🇺🇸",   "Por definir",   "🏳️",    "Levi's Stadium, Santa Clara"),
  m(29, "Grupo A", "Jun 20, 2026", "6:00 PM ET",  "Sudáfrica",     "🇿🇦",   "Por definir",   "🏳️",    "SoFi Stadium, Los Ángeles"),
  ...
  // Jun 23
  m(37, "Grupo I", "Jun 23, 2026", "3:00 PM ET",  "Francia",       "🇫🇷",   "Por definir",   "🏳️",    "AT&T Stadium, Dallas"),
  m(38, "Grupo F", "Jun 23, 2026", "6:00 PM ET",  "Países Bajos",  "🇳🇱",   "Por definir",   "🏳️",    "Rose Bowl, Los Ángeles"),
  ...
  // Jun 25
  m(43, "Grupo K", "Jun 25, 2026", "3:00 PM ET",  "Colombia",      "🇨🇴",   "Por definir",   "🏳️",    "NRG Stadium, Houston"),
...
const MATCHDAY_3 = [
  // Jun 27
  m(49, "Grupo A", "Jun 27, 2026", "3:00 PM ET",  "México",        "🇲🇽",   "Por definir",   "🏳️",    "Estadio Akron, Zapopan"),
  ...
  m(52, "Grupo B", "Jun 27, 2026", "6:00 PM ET",  "Canadá",        "🇨🇦",   "Por definir",   "🏳️",    "BMO Field, Toronto"),
  ...
  m(56, "Grupo D", "Jun 28, 2026", "6:00 PM ET",  "Paraguay",      "🇵🇾",   "Por definir",   "🏳️",    "Lincoln Financial Field, Filadelfia"),
  ...
  m(60, "Grupo F", "Jun 29, 2026", "6:00 PM ET",  "Japón",         "🇯🇵",   "Por definir",   "🏳️",    "Arrowhead Stadium, Kansas City"),
  ...
  m(66, "Grupo I", "Jul 1, 2026",  "3:00 PM ET",  "Senegal",       "🇸🇳",   "Por definir",   "🏳️",    "Gillette Stadium, Boston"),
  ...
  m(70, "Grupo K", "Jul 2, 2026",  "3:00 PM ET",  "Uzbekistán",    "🇺🇿",   "Por definir",   "🏳️",    "Estadio Akron, Zapopan"),
